...
export function renderGame(app){
  ...
  if(storeMode){
    ...
    html+='<details class="rules"><summary>规则说明</summary>'+
      ...
      (game.mode==='2v2' ?
        '<div class="rsec"><b>组队模式（2v2）</b>：4名玩家分成A、B两队（房主在大厅分配），队里任意一人先到终点，整个队伍就算获胜。阴阳迷踪步/清风霁月/妙手回春这三张"增益"卡可以选择用给自己还是队友；金玉手/梁上君子/摄星拿月/凌虚一指/叨叨不叨叨这类"针对敌方"的卡不能对自己的队友使用；狂澜/醉花阴/孤云/梨园这四名英雄的主动技能也只会瞄准敌方、不会误伤队友。青溪、墨山道两名英雄的被动在组队模式下才会真正生效，见各自说明。</div>' :
