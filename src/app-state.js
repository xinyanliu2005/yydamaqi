...
export var runtime = {
  ...
  game: null,
  unsub: null,
  ui: { error:'', homeMode:'create', selectedHero:'tianquan', pendingTarget:null, pendingChoice:null, joining:false, gameTab:'board', nameDraft:null, codeDraft:null, discardSelection:[], createMode:'1vn' }
};
